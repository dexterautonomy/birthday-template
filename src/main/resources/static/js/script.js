...
$(document).ready(function () {
    ...
    function sendMessageWithoutImageUpload(fullname, message) {
        let imageURL = "https://res.cloudinary.com/disl5oe7o/image/upload/v1666991127/xdgip1hmimbly7jmrrer.png";
    ...
    function processImpl() {
        ...
        if (image) {
            ...
            // Image upload not compulsory anymore
            ...
            if (message.length === 0) {
                ...
                if (fullname.match(/^([A-Za-z -']+)$/)) {
                    sendMessageWithoutImageUpload(fullname, message);
                } else {
                    resetKey = false;
                    let msg = "<h4>Invalid Fullname</h4><p>Kindly use valid characters in you name(s).</p>"
                    $("#loader_div").removeClass("show_").addClass("hide_");
